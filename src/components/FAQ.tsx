...
const faqs = [
  ...
  },
  {
    ...
    a: "Мы проводим пересадку волос у мужчин и женщин, пересадку бровей и бороды.",
  },
  {
    q: "Что входит в стоимость?",
    a: "Всё прозрачно. Вы подписываете официальный договор, где фиксируется стоимость, объём работ и ожидаемый результат. Никаких доплат и скрытых условий.",
  },
  {
